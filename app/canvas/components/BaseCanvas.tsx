...
import { FILLMODE_KEEP_ASPECT, RESOLUTION_AUTO, Color } from 'playcanvas';
import { useRef, ReactNode } from 'react';
import { useCanvasResize } from '../hooks/useCanvasResize';
import { PostEffectsSettings, DEFAULT_POST_EFFECTS, mergePostEffects } from '../hooks/usePostEffects';
      ...
      >
        ...
        <Entity name="camera" position={cameraPosition}>
          <Camera 
            ...
            clearColor={cameraConfig.clearColor ?? new Color(0.059, 0.09, 0.165)}
          />
