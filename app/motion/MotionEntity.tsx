...
import { type Entity as PcEntity, Script as PcScript } from "playcanvas";
...
const useMotionVec3 = (initial: number[], defaultValue = 0) => {
	...
	const array = useTransform([x, y, z], ([xVal, yVal, zVal]) => [
		xVal,
		yVal,
		zVal,
	]);
...
export const MotionLight: FC<MotionLightProps> = ({
	intensity = 1,
	type = "directional",
