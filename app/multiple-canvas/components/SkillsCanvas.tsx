...
import { Camera, Light, Render, Script, EnvAtlas } from '@playcanvas/react/components'
import { FILLMODE_KEEP_ASPECT, RESOLUTION_AUTO, Color, Vec3, StandardMaterial, Script as PcScript } from 'playcanvas'
import { useRef, useEffect, memo } from 'react'
import { useEnvAtlas } from '../../../utils/hooks'
import { StaticPostEffects } from '../../../utils/PostEffect'
import { PrimitiveConfig } from '../page'
    ...
    >
      ...
      >
        ...
        <Entity
          ...
          position={[0, 0, 0]}
          scale={[primitiveConfig.scale, primitiveConfig.scale, primitiveConfig.scale]}
        >
